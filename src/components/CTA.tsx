...
const CTA = () => {
  return (
    <section className="py-20 relative bg-white/90 rounded-[80px] shadow-sm overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-up">
          {/* Main CTA Content */}
          <div className="bg-black/90 rounded-3xl p-8 md:p-12 text-white shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-primary bg-primary text-black hover:bg-white/90 hover:text-black font-semibold px-8 py-4 text-lg"
              >
                Schedule a Call
              </Button>
            </div>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8 animate-fade-up delay-300">
            <div className="text-center">
              <div className="text-2xl font-bold text-black/90 mb-2">Free Consultation</div>
              <div className="text-black/90">No commitment required</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-black/90 mb-2">24-48h Response</div>
              <div className="text-black/90">Quick project assessment</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-black/90 mb-2">100% Satisfaction</div>
              <div className="text-black/90">Guaranteed results</div>
            </div>
          </div>
        </div>
      </div>
